...
/**
 * Shared content untuk Sheet (desktop) & Drawer (mobile).
 * Layout: hero foto → status badges → deskripsi → meta list → CTAs.
 *
 * Konsumen membungkus dengan SheetContent / DrawerContent + Header/Title.
 */
